              ...
              children: [
                ...
                CustomButton(text: "Login", onClick: (){
                  ...
                  if(!validateEmail(email)){
                    Fluttertoast.showToast(msg: "You forgot to provide an email...");
                    return;
                  }

                  if(!validatePassword(password)){
                    Fluttertoast.showToast(msg: "You forgot to provide a password...");
                    return;
                  }

                  BlocProvider.of<PetBloc>(context,listen: false).add(LoginEvent(email, password));
